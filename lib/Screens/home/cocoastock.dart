...
class CocoaStock extends StatefulWidget {
  final String user_image, user_contact, user_location, user_email,user_name;
  CocoaStock({Key key,this.user_contact,this.user_email,this.user_image,this.user_location,this.user_name}) : super(key: key);
  static const routeName = '/addBlogPage';
  @override
  _CocoaStockState createState() => _CocoaStockState();
}

class _CocoaStockState extends State<CocoaStock> {
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
              ...
              setState(() => _isLoading = false);
               _mostrarAlert('Error', 'Cocoa Qty is Blanck');
                 ...
                 // String downloadUrl = await (await uploadTask).ref.getDownloadURL();
                  ...
                  productData["name"] = widget.user_name;
                  productData["contact"] = widget.user_contact;
                  productData["email"] = widget.user_email;
                  productData["image"] = widget.user_image;
                  productData["location"] = widget.user_location;
                  productData["cocoa_qty"] = _pdtPriceController.text;
            ...
            : Text("Add Stock".toUpperCase(),style: TextStyle(fontSize: 18,fontWeight: FontWeight.bold,color: Colors.white,)
            ),
