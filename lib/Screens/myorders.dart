...
import 'package:cocoa_system/Screens/SellerMessage/Products/chatpage.dart';
                                          ...
                                          Column(
                                            ...
                                            children: <Widget>[
                                             ...
                                             SizedBox(height:10.0),
                                              ...
                                              Text('Quantity:  ${_resultsList[index]["qty"]}',style: TextStyle(fontWeight: FontWeight.w700,color: Colors.black54),),
                                              
                                              SizedBox(height:10.0),

                                              Text('Price:  GH₵ ${_resultsList[index]["totalprice"]}',style: TextStyle(fontWeight: FontWeight.w700,color: Colors.black26),),
