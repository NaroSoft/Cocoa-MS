...
class chatpage extends StatefulWidget {
  ...
  chatpage({@required this.user_email, this.seller_email, this.user_name});
  @override
  _chatpageState createState() => _chatpageState(user_email: user_email, seller_email: seller_email, user_name: user_name);
}
...
class _chatpageState extends State<chatpage> {
  ...
  String user_email,seller_email,user_name;
  _chatpageState({@required this.user_email, this.seller_email, this.user_name});
